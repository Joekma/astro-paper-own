...
![SSH 连接过程从客户端与服务器的版本协商、算法协商、密钥交换、主机密钥验证和用户认证开始，随后建立加密会话，并支持远程登录、命令执行、scp、sftp、本地端口转发、远程端口转发和跳板机场景](./images/ssh-protocol-handshake-use-cases-figure-01.png)
