---
title: 设计模式之工厂模式：简单工厂、抽象工厂模式详解
author: Joekma
pubDatetime: 2024-08-13T00:00:00.000+08:00
modDatetime: 2026-07-11T00:00:00.000+08:00
slug: design-patterns-factory
description: '深入讲解设计模式中的工厂模式、简单工厂模式、抽象工厂模式的原理和实践。'
tags:
  - Python
  - 设计模式
draft: false
...
<!-- snippet: id=design-patterns-factory-01 mode=compile python=3.12-3.14 deps=stdlib -->
```python
class Burger:
    name = ""
    price = 0.0
...
<!-- snippet: id=design-patterns-factory-02 mode=compile python=3.12-3.14 deps=stdlib -->
```python
class Snack:
    name = ""
    price = 0.0
...
<!-- snippet: id=design-patterns-factory-03 mode=compile python=3.12-3.14 deps=stdlib -->
```python
class Beverage:
    name = ""
    price = 0.0
...
<!-- snippet: id=design-patterns-factory-04 mode=compile python=3.12-3.14 deps=stdlib -->
```python
class foodFactory:
    type = ""
...
<!-- snippet: id=design-patterns-factory-05 mode=compile python=3.12-3.14 deps=stdlib -->
```python
...
<!-- snippet: id=design-patterns-factory-06 mode=display python=3.12-3.14 deps=stdlib -->
```text
...
<!-- snippet: id=design-patterns-factory-07 mode=compile python=3.12-3.14 deps=stdlib -->
```python
...
<!-- snippet: id=design-patterns-factory-08 mode=compile python=3.12-3.14 deps=stdlib -->
```python
...
工厂模式定义了一个创建对象的接口，让子类决定实例化哪个类。它具有非常好的封装性，可以屏蔽产品类，使业务场景和功能细节分而开发。简单工厂模式省去了工厂实例化的过程，而抽象工厂模式则进一步将工厂抽象化，提供了更高层次的灵活性。
