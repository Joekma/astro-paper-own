...
<!-- snippet: id=design-patterns-iterator-01 mode=display python=3.12-3.14 deps=stdlib -->
```java
...
<!-- snippet: id=design-patterns-iterator-02 mode=compile python=3.12-3.14 deps=stdlib -->
```python
list = [1,2,3,4]
for i in list:
    print(i,end=" ")  # 1 2 3 4
...
<!-- snippet: id=design-patterns-iterator-03 mode=compile python=3.12-3.14 deps=stdlib -->
```python
list = [1,2,3,4]
it = iter(list)
for i in it:
...
<!-- snippet: id=design-patterns-iterator-04 mode=compile python=3.12-3.14 deps=stdlib -->
```python
import itertools
...
<!-- snippet: id=design-patterns-iterator-05 mode=compile python=3.12-3.14 deps=stdlib -->
```python
...
<!-- snippet: id=design-patterns-iterator-06 mode=compile python=3.12-3.14 deps=stdlib -->
```python
...
<!-- snippet: id=design-patterns-iterator-07 mode=compile python=3.12-3.14 deps=stdlib -->
```python
import itertools
...
<!-- snippet: id=design-patterns-iterator-08 mode=compile python=3.12-3.14 deps=stdlib -->
```python
...
<!-- snippet: id=design-patterns-iterator-09 mode=compile python=3.12-3.14 deps=stdlib -->
```python
def square(x):
    return x ** 2
...
<!-- snippet: id=design-patterns-iterator-10 mode=compile python=3.12-3.14 deps=stdlib -->
```python
import itertools
